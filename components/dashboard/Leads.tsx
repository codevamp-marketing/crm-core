...
export default function Leads() {
    ...
    const feeds: any[] = []; // Mock feed data
                            ...
                            >
                                ...
                                <TableCell className="py-4">
                                    <span className={clsx(
                                        ...
                                        lead.stage === 'Closed Won' ? "bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-400 border-emerald-100 dark:border-emerald-800" :
                                            lead.stage === 'Closed Lost' ? "bg-rose-50 dark:bg-rose-950/30 text-rose-700 dark:text-rose-400 border-rose-100 dark:border-rose-800" :
